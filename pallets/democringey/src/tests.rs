...
use crate as pallet_democringey;
use super::*;
use codec::Encode;
use frame_support::{
...
use sp_runtime::{
	...
	testing::Header, Permill, Perbill,
};
...
mod scheduling;
mod treasury_proposals_simple_majority;
mod voting;
mod decoders;
...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Democracy: pallet_democringey::{Pallet, Call, Storage, Config, Event<T>},
...
parameter_types! {
	...
	pub const TreasuryProposalsEnactmentPeriod: u64 = 4;
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	pallet_democringey::GenesisConfig::default().assimilate_storage(&mut t).unwrap();
